...
/*   Updated: 2023/10/25 15:27:15 by rhsu             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* after left shift, it could have left with only '\0' with no data 
   in this case, clear the memory.
	r is copied with pos + 1 char including r[pos],
	i at loop end is pos + 1, which points to char after \n, 
	r[pos] suppose to be '\n'
	strlen(*b) - i gives num of char remaining in (*b)
*/
